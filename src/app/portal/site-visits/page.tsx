...
const upcomingVisits = [
  {
    ...
    location: 'Dakibiyu Estate Phase 2, Site Office',
    guide: 'Mr. Ibrahim Musa',
    status: 'confirmed',
  },
]
...
const pastVisits = [
  {
    ...
    location: 'Dakibiyu Estate Phase 2, Block B',
    guide: 'Mr. Ibrahim Musa',
    status: 'completed',
    notes: 'Block work inspection — client approved finishing spec for master bedroom.',
  },
  {
    id: 3,
    ...
    location: 'Dakibiyu Estate Phase 2, Block B',
    guide: 'Mrs. Grace Okoro',
    status: 'completed',
    notes: 'Foundation stage inspection — all clear, progressing to block work.',
  },
  {
    id: 4,
    date: 'October 8, 2025',
    ...
    guide: 'Mr. Ibrahim Musa',
    status: 'completed',
    notes: 'Initial site tour and unit allocation walk-through.',
  },
]
      ...
      {showBooking && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center px-4">
          <div
            ...
            onClick={() => !bookingSubmitted && setShowBooking(false)}
          />
          <motion.div
                ...
                <form onSubmit={handleBookVisit} className="space-y-5">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="2:00 PM">2:00 PM — 3:30 PM</option>
